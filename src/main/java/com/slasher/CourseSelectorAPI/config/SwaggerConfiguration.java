package com.slasher.CourseSelectorAPI.config;
...
public class SwaggerConfiguration {
   ...
   * encuentra en {@code com.slasher.CourseSelectorAPI}
   * @return
   */
  @Bean
  public Docket api(){
    return new Docket(DocumentationType.SWAGGER_2)
        .select()
        .apis(RequestHandlerSelectors.basePackage("com.slasher.CourseSelectorAPI.api"))
        .build();
  }
